import { Wind, Factory, CarFront, UtensilsCrossed, University } from "lucide-react";

export const DataView = ({ onSelect, selected }) => {
  const items = [
...
export const DataViewPolution = ({ onSelect, selected }) => {
  const items = [
    { label: "Pabrik", icon: <Factory size={20} /> },
    { label: "Sekolah", icon: <University size={20} /> },
    { label: "Makanan", icon: <UtensilsCrossed size={20} /> },
  ];
